...
#define  BSP_GPIO_LED1                           DEF_BIT_11
#define  BSP_GPIO_LED2                           DEF_BIT_12
#define  BSP_GPIO_LED3                           DEF_BIT_04
#define  BSP_GPIO_LED4                           DEF_BIT_07

#define  BSP_GPIO_LEDS_PORT                     GPIOC
#define  BSP_GPIO_LED1_PORT                     GPIOC
#define  BSP_GPIO_LED2_PORT                     GPIOC
#define  BSP_GPIO_LED3_PORT                     GPIOC
#define  BSP_GPIO_LED4_PORT                     GPIOC

#define  BSP_GPIO_LEDS                           (BSP_GPIO_LED1 | \
                                                 BSP_GPIO_LED2) //| \
                                                 BSP_GPIO_LED3 | \
                                                 BSP_GPIO_LED4)
