...
static  void  BSP_SwitchInit (void);
...
#ifdef STM32F107      //  otg for 105 107
//  RCC_CFGR2  for 107
...
static  void  BSP_LED_Init (void)
{
    ...
    gpio_init.GPIO_Pin   = BSP_GPIO_LEDS;
    gpio_init.GPIO_Speed = GPIO_Speed_2MHz;
    gpio_init.GPIO_Mode  = GPIO_Mode_Out_PP;

    GPIO_Init(GPIOC, &gpio_init);
    GPIO_SetBits(BSP_GPIO_LED1_PORT,BSP_GPIO_LED1);
    GPIO_SetBits(BSP_GPIO_LED2_PORT,BSP_GPIO_LED2);
//    GPIO_SetBits(BSP_GPIO_LED2_PORT,BSP_GPIO_LED2);
}
...
void  BSP_LED_Off (CPU_INT08U led)
{
    switch (led) {
        ...
        case 3:
             GPIO_SetBits(BSP_GPIO_LED3_PORT, BSP_GPIO_LED3);
             break;
             
        case 4:
             GPIO_SetBits(BSP_GPIO_LED4_PORT, BSP_GPIO_LED4);
             break;
...
void  BSP_LED_On (CPU_INT08U led)
{
    switch (led) {
        ...
        case 1:
             GPIO_ResetBits(BSP_GPIO_LED1_PORT, BSP_GPIO_LED1);
             break;

        case 2:
             GPIO_ResetBits(BSP_GPIO_LED2_PORT, BSP_GPIO_LED2);
             break;

        case 3:
             GPIO_ResetBits(BSP_GPIO_LED3_PORT, BSP_GPIO_LED3);
             break;
        case 4:
             GPIO_ResetBits(BSP_GPIO_LED4_PORT, BSP_GPIO_LED4);
             break;
...
void  BSP_LED_Toggle (CPU_INT08U led)
{
    ...
    switch (led) {
        case 0:
             ...
             pins ^= BSP_GPIO_LEDS;
             GPIO_SetBits(  BSP_GPIO_LEDS_PORT,   pins  & BSP_GPIO_LEDS);
             GPIO_ResetBits(BSP_GPIO_LEDS_PORT, (~pins) & BSP_GPIO_LEDS);
             break;
        ...
        case 3:
        case 4:
            pins = GPIO_ReadOutputData(BSP_GPIO_LEDS_PORT);
            if ((pins & (1 << (led + BSP_LED_START_BIT))) == 0) {
                 GPIO_SetBits(  BSP_GPIO_LEDS_PORT, (1 << (led + BSP_LED_START_BIT)));
             } else {
                 GPIO_ResetBits(BSP_GPIO_LEDS_PORT, (1 << (led + BSP_LED_START_BIT)));
             }
            break;
