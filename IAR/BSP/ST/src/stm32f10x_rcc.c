...
/* STM32 connectivity line devices */
     ...
     //      /* Get PLL clock source and multiplication factor ----------------------*/
      pll1mull = RCC->CFGR & CFGR_PLLMull_Mask;
      pll1mull = ( pll1mull >> 18) + 2;

      pll1source = RCC->CFGR & CFGR_PLLSRC_Mask;
      ...
      {/* HSE selected as PLL clock entry */
        ...
        {/* HSE oscillator clock divided by 2 */
          ...
          RCC_Clocks->SYSCLK_Frequency = (HSE_Value >> 1) * pll1mull;
        }
        else
       {
          RCC_Clocks->SYSCLK_Frequency = HSE_Value * pll1mull;
        }
      }
     break;
#endif      
